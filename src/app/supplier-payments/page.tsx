...
function SupplierModal({
  ...
  const [designation, setDesignation] = useState(supplier?.designation || "");
  ...
  const [bankIban, setBankIban] = useState(supplier?.bank_iban || "");

  /* ---- Financial ---- */
  const [openingBalance, setOpeningBalance] = useState(
    supplier?.opening_balance != null ? String(supplier.opening_balance) : "0"
  );
  ...
  /* ---- Status ---- */
  const [supplierStatus, setSupplierStatus] = useState<"active" | "inactive" | "blocked">(
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="Optional — contact's job title"
                    className={inputCls}
                  />
                </div>
